...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cruiser, menu);
        return true;
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn1:
                ...
                break;
            case R.id.btn2:
                intent.setClass(CruiserActivity.this, SecondDemoActivity.class);
                break;
            case R.id.btn3:
                intent.setClass(CruiserActivity.this, ThirdDemoActivity.class);
                break;
        }
